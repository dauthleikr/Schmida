      ...
      <div class="grid">
        ...
        <div class="hero-settings grid-wide">
          <div class="grid">
            ...
            ${fieldMarkup({ label:'Bildausschnitt Desktop',type:'select',options:[['center top','Mitte oben'],['center center','Mitte'],['right center','Rechts Mitte'],['left center','Links Mitte'],['center bottom','Mitte unten']] },'heroImage.position',image.position)}
